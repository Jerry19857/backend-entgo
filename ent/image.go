...
func (*Image) scanValues(columns []string) ([]interface{}, error) {
	...
	for i := range columns {
		...
		case image.FieldImage, image.FieldLongitude, image.FieldLatitude:
			values[i] = new(sql.NullString)
		case image.ForeignKeys[0]: // user_image
			values[i] = new(sql.NullInt64)
		default:
...
func (i *Image) String() string {
	...
	builder.WriteString(i.Longitude)
	builder.WriteString(", latitude=")
	builder.WriteString(i.Latitude)
	builder.WriteByte(')')
